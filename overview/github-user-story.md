...
- **Example Transformation**:
  - _Raw_: "Fixed memory leak in useEffect"
  - _TailorCV_: "Optimized React lifecycle management, reducing client-side memory overhead by 15% and improving interaction-to-next-paint (INP) metrics."
