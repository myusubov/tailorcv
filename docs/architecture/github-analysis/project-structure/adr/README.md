...
- [0004: Containerization Owner Resolution](0004-containerization-owner-resolution.md) — Docker gets a non-anchor owner adapter (`resolveContainerRootOwner`) with an infra-folder denylist and a one-directory-deep rule; the shared generic resolver is widened alongside it.
