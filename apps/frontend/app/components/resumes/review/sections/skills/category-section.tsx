      ...
      >
        ...
        {isAdding ? (
          ...
          <button
            type="button"
            onClick={onStartAdd}
            className="border-default-300 text-muted hover:border-primary hover:text-primary hover:bg-primary/5 inline-flex items-center gap-1 rounded-full border border-dashed px-2.5 py-1 text-xs transition-colors"
