...
export function ManualEntryForm({ onBack }: ManualEntryFormProps) {
  ...
  const [showSuccessModal, setShowSuccessModal] = useState(true); // Forced open for testing
  const [generatedData, setGeneratedData] =
    useState<GenerateOnboardingOutput | null>({
    ...
    defaultValues: {
      ...
      experiences: [
        ...
        },
        {
          ...
          company: 'Ascnd',
          startMonth: '02',
          startYear: '2025', // User said Feb to May 2025 in recent prompt
          endMonth: '05',
          endYear: '2025',
          isCurrent: false,
          description:
      ...
      projects: [
        {
          ...
          techStack:
            'Next.js 15, TypeScript, Supabase, PostgreSQL, Redis, Clerk',
