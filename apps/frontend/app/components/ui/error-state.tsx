...
export const ErrorState = ({
  ...
  const errorMessage =
    description || (error ? retrieveErrorMessage(error) : null);

  return (
    <div
      className={`animate-in fade-in zoom-in flex flex-col items-center justify-center px-4 py-12 text-center duration-300 ${className}`}
    >
