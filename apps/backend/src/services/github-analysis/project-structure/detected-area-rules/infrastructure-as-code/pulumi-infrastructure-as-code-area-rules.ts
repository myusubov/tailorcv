...
/**
 * Placeholder for the Pulumi infrastructure-as-code detector.
 *
 ...
 * technology `Pulumi`. No related technology is planned -- Pulumi is
 * multi-cloud, so the target provider is not inferrable from path evidence
 * alone.
